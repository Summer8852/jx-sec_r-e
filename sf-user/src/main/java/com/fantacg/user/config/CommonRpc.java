...
public class CommonRpc {
    ...
    public static boolean sms(String phone, String templateCode, ConcurrentHashMap<String, Object> templateParam) {
        try {
            //设置超时时间-可自行调整
            ...
            final String accessKeyId = RpcConstant.accessKeyId;
            //你的accessKeySecret，参考本文档步骤2
            final String accessKeySecret = RpcConstant.accessKeySecret;
            ...
            //必填:短信签名-可在短信控制台中找到
            request.setSignName(RpcConstant.signName);
            ...
            log.info("发送短信返回信息：" + sendSmsResponse.getMessage());
